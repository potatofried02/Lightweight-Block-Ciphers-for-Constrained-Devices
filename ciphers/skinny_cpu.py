class SkinnyCPU:
    ...
    def _bytes_to_nibbles(self, key: bytes) -> list[int]:
        '''
        Unpacks given key to nibbles (4 bits/nibble)
    ...
    def _sub_cells(self, plaintext: bytes) -> bytes:
        ''' 
    ...
    def _add_constants(self, plaintext: bytes) -> bytes:
        ''' 
    ...
    def _add_round_tweaky(self, plaintext: bytes) -> bytes:
        ''' 
    ...
    def _shift_rows(self, plaintext: bytes) -> bytes:
        ''' 
    ...
    def _mix_columns(self, plaintext: bytes) -> bytes:
        ''' 
